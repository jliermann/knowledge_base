...
:::danger Notice:
Please note that there are currently limitations with [SMILES](/docs/smiles) and [InChI](https://en.wikipedia.org/wiki/International_Chemical_Identifier) for inorganic and especially organometallic compounds.
:::
